...
while(1)
{
    ...
    switch (x);
      case 1;
      cout << "A wave that consists of two perpendicular transverse waves with one component of the wave being a vibrating electric field and the other being a corresponding magnetic field is called a(n) \n induction wave. \n sound wave. \n electromagnetic wave. \n" ;
      y=y+1;
      switch (choice);
        case 1;
